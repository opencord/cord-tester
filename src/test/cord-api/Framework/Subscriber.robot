...
Validate Authentication
    ...
    Run Keyword If    '${auth_pass}' == 'True'    Wait Until Keyword Succeeds    300s    2s    Check Remote File Contents    True    /tmp/wpa.log    authentication completed successfully    ${ip}    ${user}    ${pass}    ${container_type}    ${container_name}
